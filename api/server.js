...
app.use(cors({
  origin: ['https://comms-app.netlify.app','http;//localhost:3000'],
  credentials: true,
}));
...
await mongoose.connect('mongodb+srv://Hansen:abc123ab12@comms.qpzph.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', {useNewUrlParser:true,useUnifiedTopology:true,});
